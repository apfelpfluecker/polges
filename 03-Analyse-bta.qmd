...
### Daten, Operationalisierung, Limitationen, Analysestrategie {#sec-daten-bta}

Mithilfe der API des Bundestags wurden sämtliche Bundestagsanträge gesammelt, die im Untersuchungszeitraum gestellt wurden.[^03-analyse-bta-1] Aus diesem Datensatz wurden alle Anträge entfernt, die keine Anträge aus den Reihen des Bundestags waren, sondern aus dem Bundesrat heraus gestellt wurden. Auch Regierungs- und Ministeriumsanträge fielen raus, die allerdings weder einen relevanten Anteil ausmachen noch Anträge zum Thema geschlechtergerechte Sprache gestellt haben.
