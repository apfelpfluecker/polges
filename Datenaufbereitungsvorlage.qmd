...
spd <- spd %>%  
  select(id, object_id, created_time, filter, message) # Reihenfolge der Variablen ändern
...
# Exportieren zum Kodieren
write_csv2(spd, "data/social-media-data/spd_cod.csv")
...
# Exportieren zum Kodieren
write_csv2(cdu, "data/social-media-data/cdu_cod.csv")
...
# Exportieren zum Kodieren
write_csv2(csu, "data/social-media-data/csu_cod.csv")
...
# Exportieren zum Kodieren
write_csv2(gruene, "data/social-media-data/gruene_cod.csv")
...
# Exportieren zum Kodieren
write_csv2(fdp, "data/social-media-data/fdp_cod.csv")
...
# Exportieren zum Kodieren
write_csv2(afd, "data/social-media-data/afd_cod.csv")
...
# Exportieren zum Kodieren
write_csv2(linke, "data/social-media-data/linke_cod.csv")
...
# Exportieren zum Kodieren
write_csv2(bsw, "data/social-media-data/bsw_cod.csv")
