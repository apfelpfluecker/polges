...
\begin{multicols}{2}
    ...
    Matrikelnummer: $author.MatrikelNr$\\
    Studiengang: $author.Studiengang$ $sep$\\[1cm]
    $endfor$
\end{multicols}
...
\begin{multicols}{2}
    Erstgutachterin: \\
    $for(Erstgutachter)$ $Erstgutachter.name$\\ $Erstgutachter.Email$ $endfor$ \\

    Zweitgutachterin: \\
    $for(Zweitgutachter)$ $Zweitgutachter.name$\\ $Zweitgutachter.Email$ $endfor$
\end{multicols}
